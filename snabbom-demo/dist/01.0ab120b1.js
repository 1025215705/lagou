...
},{"./vnode":"node_modules/snabbdom/es/vnode.js","./is":"node_modules/snabbdom/es/is.js","./htmldomapi":"node_modules/snabbdom/es/htmldomapi.js","./h":"node_modules/snabbdom/es/h.js","./thunk":"node_modules/snabbdom/es/thunk.js"}],"src/01.js":[function(require,module,exports) {
"use strict";
...
var vnode = (0, _snabbdom.h)("div#rr", "hello word");
var app = document.querySelector("#app"); //第一个参数 可以是dmo 
//第二个参数 vnode

var oldVnode = patch(app, vnode); //重新更新数据

vnode = (0, _snabbdom.h)("div", "hello snabbodm");
patch(oldVnode, vnode); // patch(app, oldVnode);
