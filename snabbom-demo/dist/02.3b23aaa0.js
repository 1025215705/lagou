...
},{"./vnode":"node_modules/snabbdom/es/vnode.js","./is":"node_modules/snabbdom/es/is.js","./htmldomapi":"node_modules/snabbdom/es/htmldomapi.js","./h":"node_modules/snabbdom/es/h.js","./thunk":"node_modules/snabbdom/es/thunk.js"}],"src/02.js":[function(require,module,exports) {
"use strict";

var _snabbdom = require("snabbdom");

// div 中放入子元素p h
var patch = (0, _snabbdom.init)([]); //第二个参数如果是数组 放入vnode  的数组

var vnode = (0, _snabbdom.h)('div#container', [(0, _snabbdom.h)('h1', 'hello snabbdom'), (0, _snabbdom.h)('p', '这是一个p标签')]);
var app = document.querySelector("#app");
var oldVnode = patch(app, vnode); //更新p h 标签

setTimeout(function () {
  vnode = (0, _snabbdom.h)("div", [(0, _snabbdom.h)('h1', "hello rr"), (0, _snabbdom.h)('p', 'hello w')]);
  patch(oldVnode, vnode); //清空元素 h("!") 创建注释元素
